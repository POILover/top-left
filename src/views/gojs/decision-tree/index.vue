<template>
  <div class="app-container">
    <div
      id="myDiagramDiv"
      style="background-color: white; border: 1px solid black; width: 100%; height: 500px; position: relative; -webkit-tap-highlight-color: rgba(255, 255, 255, 0); cursor: auto;"
    >
      <canvas
        tabindex="0"
        width="904"
      ...
      <div
        style="position: absolute; overflow: auto; width: 904px; height: 498px; z-index: 1;"
      >
        <div style="position: absolute; width: 1px; height: 1px;"></div>
      </div>
    </div>
    <p>
      This sample allows a user to make progressive decisions about personality
      types.
    </p>
    <p>
      There are two kinds of nodes, so there are two node templates ("decision"
      and "personality") that determine the appearance and behavior of each
      <a>Node</a>.
    </p>
    <p>
      The "decision" template displays the abbreviated personality type and two
      choice buttons, all surrounded by a figure. Clicking a button will either
      expand the choice or will collapse all nodes leading from that choice.
    </p>
    <p>
      The "personality" template displays the personality descriptions, as the
...
<script>
// 去水印注释关键行 5da73c80a36455d5038e4972187c3cae51fd22 ---- node-modules/.../go.js文件  可能会引起bug
import go from "gojs";
export default {
  name: "Linear",
  components: {},
  ...
  methods: {
    init() {
      ...
      this.makeNodes(model);
      this.makeLinks(model);
